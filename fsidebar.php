...
<div class="sidebar left hidden-xs">
        <div data-scrollable>
            <div class="sidebar-block">
                <div class="profile">
                    ...
                    <h4><?php echo $dataiid['username']; ?></h4>
                </div>
            </div>
            <div class="sidebar-block">
                <div class="category">About</div>
                <ul class="list-about">
                    <li><i class="fa fa-map-marker"></i> <?php echo $dataiid['location']; ?></li>
                    <li><i class="fa fa-link"></i> <?php echo $dataiid['email'] ?>
                    </li>
                    <li><i class="fa fa-user"></i> <?php echo $dataiid['first_name'];echo$dataiid['last_name'] ;?>
                    </li>
                </ul>
            </div>
            <div class="sidebar-block">
                ...
                <div class="sidebar-photos">
                   ...
                   <button type="submit" name="confirm" class="btn btn-primary">Confirm Friend</button></form>
    ...
    <?php
     $me= $data['username'];
    $myfrnd=$dataiid['username']?>
    <?php 
if(isset($_POST['confirm']))
{
  //confirming friend request....
  $update_queryfrd="UPDATE `friends` SET `request`='1' WHERE `username`='$myfrnd'AND`fusername`='$me' ";
 $insert_queryfrd=" INSERT INTO `friends`(`username`, `fusername`, `request`) VALUES ('$me','$myfrnd','1')";
 

          mysqli_query($conn,$insert_queryfrd);
          mysqli_query($conn,$update_queryfrd);
